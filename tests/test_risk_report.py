...
MOCK_SCORECARD_GOOD = {
    "grade": "A", "total_score": 0.88,
    "components": {"delivery": 0.95, "quality": 0.92, "financial": 0.90, "geopolitical": 0.85, "capacity": 0.80},
}
MOCK_SCORECARD_BAD = {
    "grade": "F", "total_score": 0.25,
    "components": {"delivery": 0.30, "quality": 0.20, "financial": 0.25, "geopolitical": 0.15, "capacity": 0.10},
}
...
class TestBuildRiskReport:
    def test_report_contains_required_fields(self):
        ...
        for field in ["supplier_id", "supplier_name", "disruption_risk", "severity", "grade", "recommendations"]:
